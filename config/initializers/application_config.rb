...
LINE_RAR_CHANNEL_SECRET = ENV['LINE_RAR_CHANNEL_SECRET']
LINE_RAR_CHANNEL_ACCESS_TOKEN = ENV['LINE_RAR_CHANNEL_ACCESS_TOKEN']
LINE_NLC_CHANNEL_SECRET = ENV['LINE_NLC_CHANNEL_SECRET']
LINE_NLC_CHANNEL_ACCESS_TOKEN = ENV['LINE_NLC_CHANNEL_ACCESS_TOKEN']
